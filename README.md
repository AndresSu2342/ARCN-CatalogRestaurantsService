# ARCN - Catalog Restaurants Service (Backend)

Este repositorio corresponde al servicio de backend encargado de la gestión del catálogo de restaurantes (consulta, registro y administración de información relacionada al catálogo).
Su objetivo es exponer endpoints y lógica de negocio para operar sobre los recursos del catálogo.
...
```bash
git clone https://github.com/AndresSu2342/ARCN-CatalogRestaurantsService.git
cd ARCN-CatalogRestaurantsService
```
...
└── src
    ├── main
    │   ├── java/arcn/CatalogRestaurantsService
    │   │             └── CatalogRestaurantsServiceApplication.java
    │   └── resources
    │       └── application.properties
    └── test/java/arcn/CatalogRestaurantsService
                       └── CatalogRestaurantsServiceApplicationTests.java
```
